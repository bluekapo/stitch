...
export const TaskParseSchema = z.object({
	...
	description: z.string().max(1000).optional()
		.describe('Additional context or details, if any'),
	taskType: z.enum(['one-time', 'daily', 'weekly', 'ad-hoc'])
		.describe('one-time: has specific deadline. daily: repeats every day. weekly: repeats on specific day. ad-hoc: no schedule or deadline.'),
	deadline: z.string().optional()
		.describe('ISO 8601 datetime for deadline, only if user mentioned a specific date/time. null otherwise.'),
